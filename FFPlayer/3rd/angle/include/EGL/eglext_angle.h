...
#ifndef EGL_ANGLE_resize_buffers
#define EGL_ANGLE_resize_buffers 1
typedef EGLBoolean (EGLAPIENTRYP PFNEGLRESIZEBUFFERSANGLEPROC)(EGLDisplay dpy, EGLSurface surface);
#ifdef EGL_EGLEXT_PROTOTYPES
EGLAPI EGLBoolean EGLAPIENTRY eglResizeBuffersANGLE(EGLDisplay dpy, EGLSurface surface);
#endif
#endif /* EGL_ANGLE_resize_buffers */

#ifndef EGL_ANGLE_restore_lost_device
#define EGL_ANGLE_restore_lost_device 1
typedef EGLBoolean (EGLAPIENTRYP PFNEGLRESTORELOSTDEVICEANGLEPROC)(EGLDisplay dpy);
#ifdef EGL_EGLEXT_PROTOTYPES
EGLAPI EGLBoolean EGLAPIENTRY eglRestoreLostDeviceANGLE(EGLDisplay dpy);
#endif
#endif /* EGL_ANGLE_restore_lost_device */

#ifndef EGL_ANGLE_d3d_image
#define EGL_ANGLE_d3d_image 1
typedef EGLBoolean (EGLAPIENTRYP PFNEGLEXPORTD3DTEXTUREANGLEPROC)(EGLDisplay dpy, EGLContext ctx, EGLImage image, void* d3d_texture);
#ifdef EGL_EGLEXT_PROTOTYPES
EGLAPI EGLBoolean EGLAPIENTRY eglExportD3DTextureANGLE(EGLDisplay dpy, EGLContext ctx, EGLImage image, void* d3d_texture);
#endif
#endif /* EGL_ANGLE_d3d_image */
