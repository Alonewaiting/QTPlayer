...
ANGLE_UTIL_EXPORT PFNEGLEXPORTD3DTEXTUREANGLEPROC l_eglExportD3DTextureANGLE;
...
ANGLE_UTIL_EXPORT PFNEGLRESIZEBUFFERSANGLEPROC l_eglResizeBuffersANGLE;
ANGLE_UTIL_EXPORT PFNEGLRESTORELOSTDEVICEANGLEPROC l_eglRestoreLostDeviceANGLE;
...
void LoadEGL(LoadProc loadProc)
{
    ...
    l_eglExportD3DTextureANGLE =
        reinterpret_cast<PFNEGLEXPORTD3DTEXTUREANGLEPROC>(loadProc("eglExportD3DTextureANGLE"));
    ...
    l_eglResizeBuffersANGLE =
        reinterpret_cast<PFNEGLRESIZEBUFFERSANGLEPROC>(loadProc("eglResizeBuffersANGLE"));
    l_eglRestoreLostDeviceANGLE =
        reinterpret_cast<PFNEGLRESTORELOSTDEVICEANGLEPROC>(loadProc("eglRestoreLostDeviceANGLE"));
    l_eglCreateStreamProducerD3DTextureANGLE =
